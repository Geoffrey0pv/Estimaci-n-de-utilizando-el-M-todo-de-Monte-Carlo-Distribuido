...
{
    default void throwPointToCalculatePi(int amountOfPointsToThrow)
    {
        throwPointToCalculatePi(amountOfPointsToThrow, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void throwPointToCalculatePi(int amountOfPointsToThrow, java.util.Map<String, String> context)
    {
        _iceI_throwPointToCalculatePiAsync(amountOfPointsToThrow, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> throwPointToCalculatePiAsync(int amountOfPointsToThrow)
    {
        return _iceI_throwPointToCalculatePiAsync(amountOfPointsToThrow, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> throwPointToCalculatePiAsync(int amountOfPointsToThrow, java.util.Map<String, String> context)
    {
        return _iceI_throwPointToCalculatePiAsync(amountOfPointsToThrow, context, false);
    }

    /**
     * @hidden
     * @param iceP_amountOfPointsToThrow -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_throwPointToCalculatePiAsync(int iceP_amountOfPointsToThrow, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "throwPointToCalculatePi", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_amountOfPointsToThrow);
                 }, null);
        return f;
    }
